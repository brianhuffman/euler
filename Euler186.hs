...
are Caller(n) = S(2n-1) and Called(n) = S(2n) where S(1), S(2), S(3),
... come from the "Lagged Fibonacci Generator":

For 1 <= k <= 55, S(k) = [100003 - 200003k + 300007k^3] (modulo
1000000) For 56 <= k, S(k) = [S(k-24) + S(k-55)] (modulo 1000000)
...
friend of Z if X is a friend of Y and Y is a friend of Z; and so on
for longer chains.
