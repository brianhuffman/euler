...
circle of such a 60-degree triangle.

There are 1234 60-degree triangles for which r <= 100.  Let T(n) be
the number of 60-degree triangles for which r <= n, so T(100) = 1234,
